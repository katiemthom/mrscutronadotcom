...
def calc_grade():
	...
	for grade in allgrades: 
	 	grades_list.append({"category": grade.assignment.category, "atitle": grade.assignment.title, "score": grade.value, "weight": grade.assignment.weight, "date": format_date(grade.assignment.due_on), "pk": grade.grade_pk})
